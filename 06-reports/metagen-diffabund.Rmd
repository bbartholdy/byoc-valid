...
R package. P-values adjusted using the false discovery rate (FDR) method. Samples
grouped by sample type (i.e. saliva, plaque, modern calculus, artificial calculus).

First, differential abundance of experimental samples only, comparing abundance
between donated saliva, medium, and the final calculus product.
...
# highest positive and negative log-fold changes
...
# bar plot with error bars instead of points?
# fill of bars as oxygen tolerance?
```
