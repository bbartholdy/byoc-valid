...
neg_controls <- read_tsv(here("04-analysis/decontam/negative-controls.tsv"))
```
...
then visualised. Plot of estimated contributions of various sources to the artificial calculus and artificial saliva samples. Samples are arranged from left to right by how late in the experiment they were sampled, with left being the earliest samples.
