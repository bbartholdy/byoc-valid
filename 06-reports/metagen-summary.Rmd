...
genus_counts_long %>%
  ...
  ggplot(aes(x = "", y = rel_abund, fill = genus)) +
    geom_col() +
...
samples are the high relative abundance of *Streptococcus* and
*Veillonella*. Model calculus is consists mostly of *Enterococcus*
...
between saliva and medium samples. We may need to increase the frequency of
medium replacement (e.g. every two days instead of three) to help promote the
growth of aerobes. *Capnocytophaga* and *Actinomyces* spp. are predominantly
