...
\title{Assessing the validity of a calcifying oral biofilm model as a suitable proxy for dental calculus}
%\titlenote{Please provide a concise and specific title that clearly reflects the content of the article.}
\author[1]{Bjørn Peare Bartholdy}
\author[2]{Irina M. Velsko}
\author[3,4]{Shira Gur-Arieh}
\author[5]{Zandra Fagernäs}
\author[2,6]{Christina Warinner}
\author[1,7]{Amanda G. Henry}
\affil[1]{Faculty of Archaeology, Leiden University, Leiden, The Netherlands}
\affil[2]{Max Planck Institute for Evolutionary Anthropology, Department of Archaeogenetics, Leipzig, Germany}
\affil[3]{Globe Institute, University of Copenhagen, Copenhagen, Denmark}
\affil[4]{The Leon Recanati Institute for Maritime Studies, University of Haifa, Haifa, Israel}
\affil[5]{Institute of Pre- and Protohistoric Archaeology, University of Kiel, Kiel, Germany}
\affil[6]{Department of Anthropology, Harvard University, Cambridge, USA}
\affil[7]{Tropical Botany Group, Naturalis Biodiversity Center, Leiden, The Netherlands}
...
Dental calculus is increasingly used by researchers to study dietary patterns in past populations. The benefits of using dental calculus for this purpose have been clearly demonstrated, with dental calculus harbouring a wealth of microremains and biomarkers for health and diet. Previous studies have demonstrated some of the limitations and biases of how methods of processing may overlook, or even remove, some of the important information contained within the mineralised matrix. However, there are many factors that are impossible to account for *in vivo* and in archaeological material, such as exact dietary intake, and individual factors such as pH and enzyme activity, leaving some limitations that require a different approach.

\subsection*{Methods}

We present a protocol for creating a calcifying oral biofilm model that can be used to explore the biases and limitations of dental calculus as a medium for paleodietary reconstructions. We report the microbial and mineral composition, using metagenomic classification and Fourier transform infrared (FTIR) spectroscopy, respectively, in an effort to validate the model calculus as an appropriate proxy to natural dental calculus.

\subsection*{Results}

Metagenomic classification showed a microbial profile predominantly made up of (facultative) anaerobes, with a community structure that was somewhat distinct from other oral reference samples. The core genera of the model consisted of oral species, but clustered separately from oral reference samples due to a higher abundance of anaerobes. Mineral and organic components of our model mimic that of the modern and archaeological reference calculus, with carbonated hydroxyapatite as the principal compound, consistent with natural human-derived calculus.

\subsection*{Conclusions}

Overall our model is indicative of an oral environment, and has potential to validate current methods used in the analysis of archaeological dental calculus, and should be used to complement, rather than replace current *in vivo* studies.
\end{abstract}
...
experiment, separated by sampling day and sample type.}
	...
	\begin{tabledata}{$l^l^r} 
		\header Sample type & Sampling day & n \\
        \row saliva & 0 & 1 \\
        \row saliva & 3 & 1 \\
        \row saliva & 5 & 1 \\
        \row medium & 5 & 2 \\
...
consisted of adding 3 \(\mu\)l of DMSO to the indexing reaction, and extending
...
mg.}
	\centering
	\begin{tabledata}{$l^l^r} 
		\header Sampling day & n & Weight (mg) \\
        \row 7 & 2 & 0.79 \\
        \row 12 & 4 & 1.09 \\
        \row 16 & 7 & 2.00 \\
        \row 20 & 6 & 3.50 \\
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig-diversity-byoc-1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/fig-core-genera-1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.74\textwidth]{figures/fig-spca-compar-1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/fig-diffabund-comp-1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig-ftir-spectra-1.pdf}
...
\section*{Ethical approval and consent}

The study was conducted in accordance with the ethics and integrity requirements in Article 14 of the Model Grant Agreement of Horizon Europe,
which determined that ethics and consent were not required.
