...
this purpose have been clearly demonstrated, with dental calculus
harbouring a wealth of microremains and biomarkers for health and diet.
Previous studies have demonstrated some of the limitations and biases of
how methods of processing may overlook, or even remove, some of the
important information contained within the mineralised matrix. However,
there are many factors that are impossible to account for \emph{in vivo}
and in archaeological material, such as exact dietary intake, and
individual factors such as pH and enzyme activity, leaving some
limitations that require a different approach.
...
mineral composition, using metagenomic classification and Fourier
transform infrared (FTIR) spectroscopy, respectively, in an effort to
...
reference samples due to a higher abundance of anaerobes. Mineral and
organic components of our model mimic that of the modern and
archaeological reference calculus, with carbonated hydroxyapatite as the
principal compound, consistent with natural human-derived calculus.

\subsection{Conclusions}\label{conclusions}

Overall our model is indicative of an oral environment, and has
potential to validate current methods used in the analysis of
archaeological dental calculus, and should be used to complement, rather
than replace current \emph{in vivo} studies.
...
Statistical analysis was conducted in R version 4.4.3 (2025-02-28)
(Trophy Case) \citep{Rbase}. Data cleaning and wrangling performed with
...
trend (Figure~\ref{fig-shannon-compar}).
...
\section*{Ethical approval and
consent}\label{ethical-approval-and-consent}
\addcontentsline{toc}{section}{Ethical approval and consent}

The study was conducted in accordance with the ethics and integrity
requirements in Article 14 of the Model Grant Agreement of Horizon
Europe, which determined that ethics and consent were not required.

\section*{Data availability}\label{data-availability}
\addcontentsline{toc}{section}{Data availability}

\subsection*{Underlying data}\label{underlying-data}
\addcontentsline{toc}{subsection}{Underlying data}
...
\citep[\href{https://doi.org/10.4121/466b2588-9689-4d84-a8a0-5216aa39e40b}{10.4121/466b2588-9689-4d84-a8a0-5216aa39e40b},][]{byocValidData2023}.

\subsection*{Extended data}\label{extended-data}
\addcontentsline{toc}{subsection}{Extended data}

Detailed protocols for growing the oral biofilm and experimental
procedures are available on protocols.io
(\href{https://dx.doi.org/10.17504/protocols.io.dm6gpj9rdgzp/v1}{10.17504/protocols.io.dm6gpj9rdgzp/v1}).

Data can be further explored using the dashboard accompanying this
article.

https://websaur.shinyapps.io/byocDashboard/
...
https://github.com/bbartholdy/byoc-valid

The analysis scripts and source code are also archived on
4TU.ResearchData.

https://doi.org/10.4121/99932661-fe79-4f4e-a812-a8917ad18fd0
...
grant agreement number 677576 (Plant foods in human evolution: Factors
affecting the harvest of nutrients from the floral environment
{[}HARVEST{]}) (funding BPB and AGH), and grant agreement number 948365
(Hominin phyloproteomics for the Pleistocene: PalaeoPROteomics of
Skeletal Parts for Evolutionary Research {[}PROSPER{]} (funding ZF).
This project also received funding from Werner Siemens Foundation
(``PALEOBIOTECHNOLOGY''), funding IMV and CW).
