...
<!-- SourceTracker -->
The sources of taxa were estimated using SourceTracker2 [@knightsSourceTracker2011]. <!-- supp. mat. figure -->
...
model calculus samples (see Supp mat). After contaminated samples were removed,
...
<!-- species diversity -->
To monitor the development of microbial communities in our samples over the
...
Differential abundance analysis using **ANCOMBC** R package [@linANCOMBC2020]
allows us to see which species are enriched in the different sample types, giving
...
to oral reference samples. The mean Shannon index of model
...
```
<!-- ou should set up that there are known differences in the species composition of saliva and calculus, so you want to see if your calculus samples are enriched in species that are enriched in natural calculus-->
We perfomed differential abundance analysis using **ANCOMBC** R package [@linANCOMBC2020] again, this time on our model calculus samples, modern dental
calculus, and sub- and supragingival plaque.
This allows us to see which species are enriched in the different sample types,
and compare the final product of our model with naturally occurring plaque and
calculus samples.
