...
Here, we present a long-term oral biofilm model with mineralisation to address
a variety of research questions related to dental calculus, both in the present
and in the past.
The performance of the model as a proxy for dental calculus, was evaluated
...
by amylase-binding bacteria (ABB).
<!-- Why is it not present???
compare ABS species in samples (both media and final calculus) to ABS species in plaque/calculus. Different proportions? No need for a-amylase with sucrose feedings?-->.
