...
(see \@ref(fig:protocol-fig) for an overview of protocol).
...
Processing of the raw DNA reads was conducted in EAGER v. 2.4.0 [@yatesEAGER2020].
Sequences were aligned to GRCh38 human reference genome.

Metagenomic classification in Kraken 2 [@kraken2].
...
A modified \(\alpha\)-amylase (EC 3.2.1.1) assay protocol was followed (https://www.sigmaaldrich.com/technical-documents/protocols/biology/enzymatic-assay-of-a-amylase.html#M). Final volumes of standards and samples were scaled to 900 \(\mu\)l to be compatible with a 96 deepwell microplate. 

Samples of AS were taken from the bottom of the plate wells on days 0 (control), 3, 5, 6, 9, and 12, from both treatment and control wells. Samples were compared to the saliva from the donor of the biofilms.

Photometer specs

For more detailed protocol, see <!-- protocols.io? -->
