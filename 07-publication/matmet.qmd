...
<!-- FTIR specs -->
FTIR analysis was conducted on 23 samples of the biofilm sampled
on days 7, 12, 16, 20, and 24.
Samples were ground together with KBr. Grinding curves were prepared
by repeated grinding of samples from days 16, 20, and 24. Samples
from days 7 and 12 were not mineralised enough to obtain grinding
curves. The samples were analysed with a Thermo Nicolet is5 spectrometer
in transmission, at 4 cm$^-1$ resolution and an average of 32 scans
between wavenumbers 4000 and 400 cm$^-1$.
<!-- insert reference library --> and modern calculus samples.
